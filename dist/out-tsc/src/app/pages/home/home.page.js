...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.TodasSugerencias = function () {
        this.http.get(this.apiUrl + 'allSuggestions')
            .subscribe(function (data) {
            console.log(data);
        });
    };
    HomePage.prototype.Sugerencias = function () {
        var _this = this;
        this.http.get(this.apiUrl + 'suggestions')
            .subscribe(function (data) {
            _this.stories = data['data'];
