...
var PostPetsCardComponent = /** @class */ (function () {
    function PostPetsCardComponent(translate, toastCtrl, router, platform, socialSharing, actionSheetCtrl, modalCtrl, popoverCtrl, api, fb, alertCtrl, storage) {
    ...
    PostPetsCardComponent.prototype.ngOnInit = function () {
     ...
     * @param {User} user
     */
    PostPetsCardComponent.prototype.goToAccount = function (user) {
     ...
     * @param {Post} post
     */
    PostPetsCardComponent.prototype.presentActionSheet = function (post) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    PostPetsCardComponent.prototype.openMap = function (post) {
        return __awaiter(this, void 0, void 0, function () {
            var mapModal;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * @param {Post} post
     */
    PostPetsCardComponent.prototype.doShare = function (via, post) {
        return __awaiter(this, void 0, void 0, function () {
            var url, media;
            var _this = this;
            return __generator(this, function (_a) {
     ...
     * @param event
     */
    PostPetsCardComponent.prototype.openPop = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            var popoverCtrl;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.popoverCtrl.create({
                            component: PostPetsCardPopComponent,
     ...
     */
    PostPetsCardComponent.prototype.update = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modalCtrl;
            var _this = this;
            return __generator(this, function (_a) {
     ...
     * Elimina un registro.
     */
    PostPetsCardComponent.prototype.delete = function () {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
     ...
     * Abre un alert.
     */
    PostPetsCardComponent.prototype.report = function () {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
     ...
     */
    PostPetsCardComponent.prototype.presentToast = function (text) {
        return __awaiter(this, void 0, void 0, function () {
            var toast;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ], PostPetsCardComponent.prototype, "post", void 0);
    __decorate([
        Output(),
        __metadata("design:type", EventEmitter)
    ], PostPetsCardComponent.prototype, "appPostDeleted", void 0);
    PostPetsCardComponent = __decorate([
        Component({
            selector: 'app-pets-post-card',
            templateUrl: './post-pets-card.component.html',
            styleUrls: ['./post-pets-card.component.scss']
        }),
    ...
    return PostPetsCardComponent;
}());
export { PostPetsCardComponent };
var PostPetsCardPopComponent = /** @class */ (function () {
    function PostPetsCardPopComponent(popoverCtrl, navParams, storage) {
        this.popoverCtrl = popoverCtrl;
        this.navParams = navParams;
        this.storage = storage;
        this.isSelf = false;
    }
    PostPetsCardPopComponent.prototype.ngOnInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    PostPetsCardPopComponent.prototype.dissmis = function (acction) {
        this.popoverCtrl.dismiss(acction);
    };
    PostPetsCardPopComponent = __decorate([
        Component({
            selector: 'app-pest-post-card-pop',
    ...
    return PostPetsCardPopComponent;
}());
export { PostPetsCardPopComponent };
//# sourceMappingURL=post-pets-card.component.js.map